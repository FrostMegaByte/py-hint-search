...
from clienttry.json_rpc_endpoint import JsonRpcEndpoint
from clienttry.lsp_client import LspClient
...
def main():
    ...
    chello = InitializedParams
    print(converter.unstructure(chello, chello.))
    # print(attrs.asdict(test))
    # print(attrs.asdict(InitializedParams))
    ...
    # converter = converters.get_converter()
    # obj = converter.unstructure(converters, InitializedParams)
    lsp_client.send_notification("initialized", InitializedParams)
