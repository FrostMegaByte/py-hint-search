...
class LspEndpoint(threading.Thread):
    ...
    def _send_message(self, method_name, params, id=None):
        self.json_rpc_endpoint.write_message(method_name, params, id)
    ...
    def send_request(self, method_name, params):
        ...
        cond.acquire()
        self._send_message(method_name, params, current_id)
        cond.wait()
        cond.release()
    ...
    def send_notification(self, method_name, params):
        self._send_message(method_name, params)
