...
# from client.protocol import ClientCapabilities
# from client.lsp_structs import LANGUAGE_IDENTIFIER, TextDocumentItem
...
def main():
    ...
    document = pylspclient.lsp_structs.VersionedTextDocumentIdentifier(uri, version + 1)
